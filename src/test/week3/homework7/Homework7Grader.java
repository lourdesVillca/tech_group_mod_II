...
public class Homework7Grader
{
    public static void main(final String[] array) {
        final Result runClasses = JUnitCore.runClasses(new Class[] { DoorTest.class, MapSiteTest.class, MazeGameTest.class, RandomizedMazeGameTest.class, RoomTest.class, WallTest.class, MazeTest.class });
