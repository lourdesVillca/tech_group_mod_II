...
public class Homework4Grader
{
    public static void main(final String[] array) {
        final Result runClasses = JUnitCore.runClasses(new Class[] { DepthTest.class, HeightTest.class, FindNodeTest.class, IsBalancedNodeTest.class, IsBalancedTreeTest.class });
