...
public class Homework5Grader
{
    public static void main(final String[] array) {
        final Result runClasses = JUnitCore.runClasses(new Class[] { ParseMovieRatingsTest.class, GetAlphabeticalMoviesTest.class, GetAlphabeticalMoviesAboveRatingTest.class, RemoveAllRatingsBelowTest.class });
