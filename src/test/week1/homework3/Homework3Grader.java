...
public class Homework3Grader
{
    public static void main(final String[] array) {
        final Result runClasses = JUnitCore.runClasses(new Class[] { CalculateScoresTest.class, CalculateSentenceScoreTest.class, AllWordsTest.class, ReadFileTest.class });
